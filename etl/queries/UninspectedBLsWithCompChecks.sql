...
AND lt.name NOT            IN ('Activity', 'Amusement', 'Annual Pole', 'Bingo', 'Carnival', 'Dumpster License - Construction', 'Food Caterer', 'Food Estab, Retail Non-Permanent Location (Event)', 'Food Establishment, Outdoor', 'Food Establishment, Retail Perm Location (Large)', 'Food Manufacturer / Wholesaler', 'Food Preparing and Serving', 'Handbill Distribution', 'Honor Box', 'Limited Occasion', 'Outdoor Advertising Sign', 'Overhead Wire', 'Pawn Shop', 'Precious Metal Dealer', 'Promoter Registration', 'Public Garage / Parking Lot', 'Rental', 'Scales and Scanners', 'Sidewalk Cafe', 'Small Games Of Chance', 'Special Permit', 'Tow Company', 'Vacant Commercial Property', 'Vacant Residential Property / Lot', 'Vendor - Center City Vendor', 'Vendor - Motor Vehicle Sales', 'Vendor - Neighborhood Vending District', 'Vendor - On Foot', 'Vendor - Pushcart', 'Vendor - Sidewalk Sales', 'Vendor - Special Vending')